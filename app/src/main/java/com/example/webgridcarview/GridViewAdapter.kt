...
class GridViewAdapter(
    ...
    private var layoutInfater : LayoutInflater? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if (layoutInfater == null) {
            layoutInfater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        }
        if (convertView == null) {
            convertView = layoutInfater!!.inflate(R.layout.gridview_item, null)
        }
